...
import scene.Scene;
    ...
    public class LightsTests {
        ...
        public void sphereMultiple(){
            scene1.geometries.add(sphere);
            scene1.lights.add(new SpotLight(new Color(500, 300, 0), new Point3D(-130, -50, 5), new Vector(1, 2, -2)) //
                    .setKl(0.00001).setKq(0.0000000001));
            scene1.lights.add(new PointLight(new Color(500, 300, 0), new Point3D(60, -120, 70))//
                    .setKl(0.00001).setKq(0.000001));
            scene1.lights.add(new DirectionalLight(new Color(500, 300, 0), new Vector(-1, -1, 0.5)));
        ...
        public void trianglesMultiple() {
            scene2.geometries.add(triangle1.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(300)),
                    triangle2.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(300)));
            scene2.lights.add(new SpotLight(new Color(500, 250, 250), new Point3D(10, -10, -130), new Vector(-15, -2, -1)) //
                    .setKl(0.0001).setKq(0.000005));
            scene2.lights.add(new PointLight(new Color(500, 250, 250), new Point3D(10, -10, -130)) //
                    .setKl(0.0005).setKq(0.0005));
            scene2.lights.add(new DirectionalLight(new Color(300, 150, 150), new Vector(1, 0, -2)));
