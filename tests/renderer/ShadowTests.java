...
public class ShadowTests {
    ...
    /**
     * Produce a picture of a sphere and closer triangle with point light and shade
     */
    @Test
    public void sphereCloserTriangle() {
        scene.geometries.add( //
                new Sphere(60, new Point3D(0, 0, -200)) //
                        .setEmission(new Color(java.awt.Color.BLUE)) //
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)), //
                new Triangle(new Point3D(-63, -33, 7), new Point3D(-33, -63, 7), new Point3D(-61, -61, 3)) //
                        .setEmission(new Color(java.awt.Color.BLUE)) //
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)) //
        );
        scene.lights.add( //
        ...
        Render render = new Render(). //
                setImageWriter(new ImageWriter("shadowSphereCloserTriangle", 400, 400)) //
                .setCamera(camera) //
                .setRayTracer(new BasicRayTracer(scene));
        render.renderImage();
        render.writeToImage();
     ...
     */
    @Test
    public void sphereClosestTriangle() {
        scene.geometries.add( //
                new Sphere(60, new Point3D(0, 0, -200)) //
                        .setEmission(new Color(java.awt.Color.BLUE)) //
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)), //
                new Triangle(new Point3D(-53, -23, 17), new Point3D(-23, -53, 17), new Point3D(-51, -51, 13)) //
                        .setEmission(new Color(java.awt.Color.BLUE)) //
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)) //
        );
        scene.lights.add( //
        ...
        Render render = new Render(). //
                setImageWriter(new ImageWriter("shadowSphereClosestTriangle", 400, 400)) //
                .setCamera(camera) //
                .setRayTracer(new BasicRayTracer(scene));
        render.renderImage();
        render.writeToImage();
